...
const cases = [
  ...
  {
    title: "import map: should accept deno.land/std@v",
    input: `{
      "import_map": {
  ...
  {
    title: "source code: should accept deno.land/std@v",
  ...
  {
    title: "deno-types: should accept deno.land/std",
    input: `// @deno-types="https://deno.land/std@0.204.0/path/mod.ts";`,
    currentValue: "0.204.0",
    depName: "https://deno.land/std",
  },
  {
    title: "deno-types: should accept deno.land/std@v",
    input: `// @deno-types="https://deno.land/std@v1.0.0/some/mod.ts";`,
    currentValue: "v1.0.0",
    depName: "https://deno.land/std",
  },
  {
    title: "deno-types: should accept deno.land/x",
